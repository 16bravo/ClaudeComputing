...
public class Constants {
	...
	public static String USER_NAME = "cbravo"; // votre nom d'utilisateur : XXX
	public static String PASS_WORD = "63S?EMp9"; // votre mot de passe . XXX
	...
	public static String CT_BASE_NAME = "ct-tpiss-virt-B2-ct";  // "XX" à remplacer par votre numéro de binôme. Exemple: ct-tpgei-virt-A3-ct à concaténer avec le numéro du CT
	public static long CT_BASE_ID = 2200;	 // à modifier (cf. sujet de tp) XXX
	...
	public static float MAX_THRESHOLD = 0.01f;
